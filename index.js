...
var words = [
    ...
    'Carta do sábio ao jovem\n\n"Mais vale um pássaro na mão que dois voando."',
    'Carta do rei cego aos seus súditos cegos\n\n"Em minha terra, quem tiver olho será o rei."',
    'Carta do sábio ao jovem\n\n"Uma mão lava a outra e as duas lavam o rosto."',
    'Carta do sábio ao jovem impaciente\n\n"Uma panela bem vigiada nunca ferve."',
...
setInterval(BotAction, 60*1000*60*24);
